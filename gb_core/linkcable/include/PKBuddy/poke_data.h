...
struct pokemon_base_stats {
	const char* name;
	const unsigned char index;
	const unsigned char base_hp;
	const unsigned char base_atk;
	const unsigned char base_def;
	const unsigned char base_spd;
	const unsigned char base_spc;
	const unsigned char base_spc_atk;
	const unsigned char base_spc_def;
	const unsigned char type[2];
	const unsigned char move[4];
	const Growth growth;
	const Gender gender_ratio;
};

const pokemon_base_stats pokemon_table[] = {
